...
static uint8_t testArray[128];
extern uint8_t flashTestArray[1280];
int main(void) {
	setAddress(flashTestArray,flashTestArray+sizeof(flashTestArray));
//	for(int k=0;k<sizeof(testArray);k++){
//		testArray[k] = k;
//	}
//	memset(flashTestArray,0x55,sizeof(flashTestArray));
//	while(writeChunk(&testArray[0],20,0));
//	while(writeChunk(&testArray[20],20,0));
//	while(writeChunk(&testArray[40],20,0));
//	while(writeChunk(&testArray[60],20,0));
//	while(writeChunk(&testArray[80],20,0));
//	while(writeChunk(&testArray[100],20,0));
//	while(writeChunk(&testArray[120],8,1));
